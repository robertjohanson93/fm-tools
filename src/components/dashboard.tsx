  ...
  return (
    <div className='overflow-hidden rounded-[0.5rem] border bg-background shadow'>
      <div className='flex-1 space-y-4 p-8 pt-6'>
         <h2 className='text-3xl font-bold tracking-tight'>Wage structure</h2>
         <Tabs defaultValue="club">
               ...
               <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
                  <Card className='w-full'>
                     <CardHeader className='p-6 flex flex-row items-center justify-between space-y-0 pb-2'>
                        <CardTitle className='tracking-tight text-sm font-medium'>Players</CardTitle>
                        <Users color="gray" size={24} />
                     </CardHeader>
                     <CardContent>
                        <CardDescription className='text-primary text-2xl font-bold'>48</CardDescription>
                     </CardContent>
                  </Card>
                  <Card className='w-full'>
                     <CardHeader className='p-6 flex flex-row items-center justify-between space-y-0 pb-2'>
                        <CardTitle className='tracking-tight text-sm font-medium'>Salary</CardTitle>
                        <PoundSterling color="gray" size={24} />
                     </CardHeader>
                     <CardContent>
                        <CardDescription className='text-primary text-2xl font-bold'>£57 225,00</CardDescription>
                     </CardContent>
                  </Card>
               </div>
            ...
            <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
               <Card className='w-full'>
                  ...
                  <CardContent>
                     <CardDescription className='text-primary text-2xl font-bold'>23</CardDescription>
                  </CardContent>
               </Card>
               <Card className='w-full'>
                  <CardHeader className='p-6 flex flex-row items-center justify-between space-y-0 pb-2'>
                  ...
                  <CardContent>
                     <CardDescription className='text-primary text-2xl font-bold'>£55 925,00</CardDescription>
                  </CardContent>
               </Card>
            </div>
            <div className='w-full'>
            ...
            <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
               <Card className='w-full'>
                  ...
                  <CardContent>
                     <CardDescription className='text-primary text-2xl font-bold'>25</CardDescription>
                  </CardContent>
               </Card>
               <Card className='w-full'>
                  <CardHeader className='p-6 flex flex-row items-center justify-between space-y-0 pb-2'>
                  ...
                  <CardContent>
                     <CardDescription className='text-primary text-2xl font-bold'>£1 300,00</CardDescription>
                  </CardContent>
               </Card>
            </div>
            <div className='w-full'>
